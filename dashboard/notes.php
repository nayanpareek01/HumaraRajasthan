            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-xs-4">
            <a href="uploadnote.php" class="btn btn-primary">Add New Place</a>
            </div>
                         My Places
                        </h1>
<div class="row">
...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete this post?')\" href='?del=$file_id'><i class='fa fa-times' style='color: red;'></i>delete</a></td>";    echo "</tr>";
}
}
else {
