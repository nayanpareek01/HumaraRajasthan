...
<h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" > Jaipur Rajasthan</font></marquee></center>
                        </h3>
<div class="row">
<div class="col-lg-12">
...
<?php 
 ...
 <h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" ><?php echo $_SESSION['course']; ?> </font><font color="brown"> citizen</font></marquee></center>
                        </h3>
